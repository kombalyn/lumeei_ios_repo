...
class DlnaDeviceList2 extends StatefulWidget {
  final String? videoId;
  // ignore: prefer_typing_uninitialized_variables
  final index;
  const DlnaDeviceList2({Key? key, this.videoId, this.index}) : super(key: key);
...
class _DlnaDeviceListState extends State<DlnaDeviceList2> {
