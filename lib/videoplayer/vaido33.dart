// ignore_for_file: override_on_non_overriding_member, unused_field, prefer_typing_uninitialized_variables, library_private_types_in_public_api, unused_element, prefer_final_fields, deprecated_member_use, unnecessary_string_interpolations, avoid_print
...
///
late String urllocal;

class VideoApp222 extends StatefulWidget {
  const VideoApp222({
    super.key,
    this.link,
    this.userAgent,
...
class _VideoAppState extends State<VideoApp222> {
  ...
  //   setState(() {
  //     // تغيير النسبة المئوية لتغيير حجم مشغل الفيديو
  //     _aspectRatio = _aspectRatio == 16 / 9 ? 4 / 3 : 16 / 9;
  //   });
  // }
          ...
          child: Stack(
            ...
            children: [
              Container(
                ...
                width: b == false ? getSize(context).width : null,
                height: b == false ? getSize(context).height : null,
